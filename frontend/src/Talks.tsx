...
const Talks = () => (
  <>
    <Helmet>
      <title>My talks | PGJones</title>
      <meta
        name="description"
        content="List and information on public talks I have given."
      />
    </Helmet>
    <ColumnContainer>
      <Card
        ...
        body={
          <>
            <SP>
              ...
              and frameworks to exist and develop independently, however, WSGI
              is unable to support websockets or the new async/await syntax.
              ASGI is the asynchronous spiritual successor to WSGI, with
              websockets and async support built in.
            </SP>
          </>
        }
        footer={
        ...
        body={
          <>
            <SP>
              ...
              framework, Flask, is incompatible with asyncio. The Quart
              framework aims to solve this by reimplementing the Flask API using
              asyncio.
            </SP>
            <SP>
              I intend to talk about the lessons and difficulties encountered
              with Flask, Asyncio and the combination. Detailing the
              difficulties calling coroutines from synchronous functions, and
              the eventual workaround, how the crux of Flask, global thread
              locals, have equivalents and how they work, finishing with a
              discussion about how Python monkey patching allows for some of the
              Flask extensions to work.
            </SP>
          </>
        }
        footer={
