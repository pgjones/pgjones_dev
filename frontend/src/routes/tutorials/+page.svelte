...
<svelte:head>
  <title>Tutorials | PGJones</title>
  <meta name="description" content="Coding tutorials." />
</svelte:head>

<section class="cta-section theme-bg-light py-5">
  <div class="container text-center">
    <h2 class="heading">Coding tutorials</h2>
    <div class="intro mb-4">These are my tutorials.</div>
  </div>
</section>
...
<section class="blog-list px-3 py-5 p-md-5">
  <div class="container">
    <div class="row">
      <TutorialCard
        title="How to run scheduled/cron tasks with Quart"
        video="https://www.youtube-nocookie.com/embed/_yqSYS6WVoM"
      />
      <TutorialCard
